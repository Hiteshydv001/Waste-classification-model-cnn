...
st.markdown(
    ...
    .main {
        background-image: linear-gradient(to right, #5a85c6, #248ec5, #0095ba, #009aa9, #1a9d94);/* Slightly transparent white */
        border-radius: 15px;
        padding: 20px;
        margin: 10px;
...
st.markdown(
    ...
    <div style="text-align: center; font-family: Arial, sans-serif; font-size: 21px;">
        🌟 Powered by <b style="font-size: 25px;">TensorFlow</b>, <b style="font-size: 25px;">OpenCV</b>, and <b style="font-size: 25px;">Streamlit</b><br><br>
        <b style="font-size: 25px;">Made by:</b> Hitesh Kumar<br>
        <a href="https://www.linkedin.com/in/hitesh-kumar-aiml/" target="_blank" style="color: #0a66c2; font-size: 23px;">LinkedIn</a> | 
        <a href="https://github.com/Hiteshydv001" target="_blank" style="color: #333; font-size: 23px;">GitHub</a><br><br>
        🎉<b style="font-size: 25px;">Edunet-Shell Skills4Future AICTE Internship Project</b> (Nov-Dec)<br>
        Focused on <b style="font-size: 25px;">Green Skills</b> & <b style="font-size: 25px;">AI</b>.
    </div>
    """,
    unsafe_allow_html=True,
)
